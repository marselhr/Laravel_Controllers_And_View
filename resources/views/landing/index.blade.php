    ...
    <div class="carousel slide" data-bs-ride="carousel" id="carouselExampleIndicators">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img alt="..." class="d-block w-100" src="{{ asset('img/home-1.jpg') }}">
            ...
            <div class="carousel-item">
                <img alt="..." class="d-block w-100" src="{{ asset('img/home-2.jpg') }}">
                <div class="carousel-caption">
            ...
            <div class="carousel-item">
                <img alt="..." class="d-block w-100" src="{{ asset('img/home-3.jpg') }}">
                <div class="carousel-caption">
...
@section('content')
    ...
    <section class="about section-padding" id="about">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-12 col-12 rounded-lg wrapper-about-img">
                    <div class="about-img img"><img alt="" class="img-fluid "
                            src="{{ asset('img/1000079670.jpg') }}">
                    </div>
                </div>
                <div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
                    <div class="about-text">
                        <h2>Some things are up to us,<br>
                            some things are not up to us</h2>
                        <p>Dengan memusatkan perhatian dan usaha kita pada pikiran, sikap, dan tindakan kita sendiri, kita
                            dapat mencapai kedamaian dan kebahagiaan, bahkan dalam menghadapi tantangan eksternal yang
                            sulit. Filsuf Stoik juga menyarankan agar kita menerima hal-hal yang di luar kendali kita dengan
                            sikap bijaksana, karena mengkhawatirkan hal-hal tersebut tidak akan mengubah situasi dan hanya
                            akan menimbulkan penderitaan.</p><a class="btn btn-warning"
                            href="{{ route('landing.profile') }}">See my profile</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card text-white text-center bg-dark pb-2">
                        <div class="card-body">
                            ...
                            <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci
                                eligendi modi temporibus alias iste. Accusantium?</p><button
                ...
                <div class="col-12 col-md-12 col-lg-4">
                    <div class="card text-light text-center bg-white pb-2">
                        <div class="card-body text-dark">
                            ...
                            <p class="lead">Lorem ipsum dolor sit amet consectetur adipisicing elit. Adipisci
                                eligendi modi temporibus alias iste. Accusantium?</p><button
                                class="btn bg-warning text-dark">Learn More</button>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-12 col-lg-4">
